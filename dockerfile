...
USER airflow
RUN pip install --no-cache-dir dbt-core==1.8.0 dbt-postgres==1.8.0 beautifulsoup4 playwright playwright-stealth requests python-dotenv boto3 psycopg2-binary
